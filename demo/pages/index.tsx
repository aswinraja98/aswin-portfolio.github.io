...
export default function SentimentDemo() {
  ...
  const handleSubmit = async (e?: React.FormEvent) => {
    ...
    try {
      ...
      setResult(data.sentiment || data.error || "No result");
    } catch (err) {
        ...
        <div className="bg-slate-800 rounded-lg p-4 border border-slate-700">
          ...
          <div className="mb-2 text-sm text-slate-300">
            <ul className="list-disc ml-5">
              <li><span className="font-semibold text-white">Sentiment Analysis:</span> Uses VADER (Valence Aware Dictionary and sEntiment Reasoner) for robust sentiment scoring</li>
              <li><span className="font-semibold text-white">API:</span> Next.js API route (no backend server required)</li>
          ...
          <div className="flex flex-wrap gap-2 mt-2">
            ...
            <span className="bg-[#06B6D4]/10 text-[#06B6D4] border border-[#06B6D4]/30 px-2 py-1 rounded text-xs font-semibold">VADER</span>
